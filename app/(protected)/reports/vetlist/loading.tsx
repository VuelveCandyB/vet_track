    ...
    <div className="space-y-5">
      <div className="flex justify-between">
        ...
        <div className="flex gap-2">
          <Skeleton className="h-8 w-28 rounded-md" style={{ background: '#1e2540' }} />
      ...
      <div className="rounded-xl overflow-hidden" style={{ background: '#131829', border: '1px solid #252d4a' }}>
        ...
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-5 px-4 py-3" style={{ borderBottom: '1px solid #1e2235' }}>
